...
MACRO(CONFIGURE_LIBRARY HEADER_NAME HEADER_PATHS LIBRARY_NAME LIBRAY_PATHS)
    MESSAGE(STATUS "")
    MESSAGE(STATUS "#### Configuring ${LIBRARY_NAME} header files & library")
    ...
    ELSE (NOT HAVE_INCLUDE_${LIBRARY_NAME})
      #MESSAGE(FATAL_ERROR "#### Cannot find ${LIBRARY_NAME} header file ${HEADER_NAME}")
      MESSAGE(WARNING "#### Cannot find ${LIBRARY_NAME} header file ${HEADER_NAME}")
    ENDIF(HAVE_INCLUDE_${LIBRARY_NAME})
